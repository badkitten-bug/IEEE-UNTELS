import './archivo_tbQFztXb.mjs';
import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, i as renderHead, j as renderComponent, k as renderSlot, u as unescapeHTML, h as addAttribute, s as spreadAttributes } from '../astro_09mVCEYX.mjs';
import 'kleur/colors';
import 'clsx';
import 'cssesc';
/* empty css                          */
...
}, "C:/Users/Steve/Escritorio/IEEE-PAGE/src/components/Logo.astro", void 0);

const $$Astro$3 = createAstro();
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$Footer;
  return renderTemplate`${maybeRenderHead()}<footer class="bg-black/40 mt-24"> <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8"> <div class="md:flex md:justify-between"> <div class="mb-6 md:mb-0"> <a href="#" class="flex items-center"> ${renderComponent($$result, "Logo", $$Logo, { "class": "w-36" })} </a> </div> <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3"> <div> <h2 class="mb-6 text-sm font-semibold uppercase text-white">Legal</h2> <ul class="text-gray-400 font-medium"> <li class="mb-4"> <a href="https://flowbite.com/" class="hover:underline">Aviso Legal</a> </li> <li> <a href="https://tailwindcss.com/" class="hover:underline">Privacidad</a> </li> <li> <a href="https://tailwindcss.com/" class="hover:underline">Cookies</a> </li> </ul> </div> <div> <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">
Web Map
</h2> <ul class="text-gray-400 font-medium"> <li class="mb-4"> <a href="/" class="hover:underline">Home</a> </li> <li> <a href="/info" class="hover:underline">Info</a> </li> <li> <a href="/archivo" class="hover:underline">Archivo</a> </li> </ul> </div> <div> <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">
Legal
...
const $$file$1 = "C:/Users/Steve/Escritorio/IEEE-PAGE/src/pages/en/index.astro";
const $$url$1 = "/en";
...
const $$file = "C:/Users/Steve/Escritorio/IEEE-PAGE/src/pages/index.astro";
const $$url = "";
